...
JSON_PATH = "/home/anastasia/PycharmProjects/medguides/parser/ru-parser/russian_guidelines.json"
REAL_PDF_DIR = "/home/anastasia/PycharmProjects/medguides/parser/ru-parser/pdf"
...
for record in data:
    ...
    country = record.get("country", "RUS")
    source = record.get("source", "")
    mkb_codes = json.dumps(record.get("mkb_codes", []))
    mkb_11 = "[]"
    mkb_mapping = "{}"
    json_content = None
...
conn.commit()
conn.close()
print(f"✅ Загружено {inserted} российских рекомендаций.")
